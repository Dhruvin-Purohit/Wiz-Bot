...
module.exports = class BotBanCommand extends Command {
  constructor(client) {
    super(client, {
      name: 'botunban',
      usage: 'botunban <user ID>',
      description: 'botunban a particular user',
      type: client.types.OWNER,
      ownerOnly: true,
      examples: ['botunban 772047962342948875']
    });
  }
  async run(message, args) {
    ...
    /*if (!rgx.test(userid))
      ...
      if (userid === config.ownerid) {
        ...
        .setDescription(`${emojis.Phew} If You cannot Bot-Ban yourself, how can you even Bot-Unban Yourself?`)
